(define (domain BELKAN)
  ...
  (:action entregar_objeto
    ...
    :precondition (and (or (jugador_tiene_objeto ?x ?y) (jugador_mochila_llena ?x ?y)) (posicion_jugador ?x ?z) (posicion_personaje ?p ?z) (< (num_objetos_personaje ?p) (max_objetos_personaje ?p))) ; el jugador tiene un objeto, el personaje tiene las manos vacías, y están en la misma zona
    :effect
    (and
